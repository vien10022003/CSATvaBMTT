...
const message = Math.floor(Math.random() * 500); // Giả sử thông điệp là số nguyên
...
console.log(`🔍 Xác minh chữ ký2:`, verifySignature(178179, 275, { e: 3, n: 333643 }) ? "✅ Hợp lệ" : "❌ Không hợp lệ");
